function [eulerAngles,rotCentre,outDir] = ...
    shoemake_3D_v04_07_02_Abdo(inDir,inFile,DUunits,MainDispl)
...
plotAllDis(X,Y,Z,abs(Ux),abs(Uy),abs(Uz),DUunits,MainDispl)
